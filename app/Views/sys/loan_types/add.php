        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="Amount" class="form-label">Capital (Rs.)</label>
                            <input type="text" class="form-control" id="Capital" name="Capital" value="<?= set_value('Capital') ?>">
                                                    </div>
