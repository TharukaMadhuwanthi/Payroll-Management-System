 ...
 <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-bar-chart"></i><span>Changing Item Amount</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#icons-nav-masterdetails" data-bs-toggle="collapse" href="#">
                <i class="bi bi-archive-fill"></i><span>Fixed Item Amount</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
