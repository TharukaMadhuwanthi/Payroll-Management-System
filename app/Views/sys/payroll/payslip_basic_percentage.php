                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align="right"><?= $basic['Amount'] ?></td>
                                </tr>
                                 <tr>
                                    <td><strong>Basic for month:</strong></td>
                                    <td align="right"><?= $basic['Amount']/$days['WorkedDays']*25 ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Percentage of basic:</strong></td>
                                    <td align="right"><?=$basic['Amount']/( $basic['Amount']/$days['WorkedDays']*25)*100 ?>%</td>
                                </tr>
