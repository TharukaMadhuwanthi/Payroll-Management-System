                ...
                <div class="row">
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <h1>Payroll Management System - Ratnapura Region</h1>
                            <?= form_open('useraccount/sendResetLink', array("class" => "row", "novalidate" => "novalidate")) ?>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="text" name="email" class="form-control" id="emial"  required>
                                </div>
                            </div>
                            <div> <button class="btn-get-started scrollto" type="submit">ok</button></div>
